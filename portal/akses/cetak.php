...
$q = mysql_query("SELECT SISWA.*,JURUSAN.* FROM SISWA,JURUSAN WHERE SISWA.ID_JURUSAN=JURUSAN.ID_JURUSAN AND SISWA.NIS = '$n1z'") or die(mysql_error());
...
<table width="100%" border="0">
  <tr>
      <td width="145" colspan="3" align="center"><center><img src="../../backend/siswa/photo/<?=$row['FOTO'];?>" width="150px" height="150px"></center></td>
  </tr>
  <tr>
